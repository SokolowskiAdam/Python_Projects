...
def reset_timer() -> None:
    window.after_cancel(timer)  # finish countdown
...
def count_down(count: int) -> None:
    ...
    if count > 0:
        global timer
        timer = window.after(1000, count_down, count - 1)  # delay in milliseconds
    else:
        start_timer()
        marks = ""
...
check_marks = Label(fg=GREEN, bg=YELLOW, font=14)
